    ...
    return(
        <div className="center ma">
            <div id="imageContainer" className="absolute mt2 fl w-70">
                ...
                <div id="concepts">
                    {/* Mapping über die Liste der Konzepte */}
                    {foodList.map((concept, index) => (
